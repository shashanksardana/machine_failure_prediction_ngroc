...
model_path = hf_hub_download(repo_id="ShashankSardana/Machine-Failure-Prediction-NGROC", filename="best_machine_failure_model_v2.joblib")
model = joblib.load(model_path)

# Streamlit UI for Machine Failure Prediction
st.title("Machine Failure Prediction App NGROC")
st.write("""
